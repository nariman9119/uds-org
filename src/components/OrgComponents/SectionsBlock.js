            ...
            <section>
                <div className='start-block'>
                    ...
                    <a className='sections-block-schedule' target='_blank'
                       href={'/content/' + this.props.schedule_url}>
