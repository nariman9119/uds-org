...
INSERT INTO uds.`club_photos` (`id`, `photo`, `club_id`)
VALUES
...
INSERT INTO uds.`clubs` (`id`, `address`, `organization_id`)
VALUES
	(1,'ул. Вавилова, д. 7',1),
...
INSERT INTO uds.`districts` (`id`, `name`)
VALUES
	(1,'ЦАО'),
	(2,'ЮЗАО'),
	(3,'СВАО'),
...
INSERT INTO uds.`organizations` (`id`, `url`, `short_name`, `name`, `area_id`, `short_description`, `about`, `logo`, `video`, `address`, `schedule_url`)
VALUES
...
INSERT INTO uds.`section_groups` (`id`, `name`)
VALUES
	(1,'2-6 лет'),
	(2,'7-11 лет'),
	(3,'12-17 лет'),
...
INSERT INTO uds.`sections` (`id`, `name`, `group_id`, `organization_id`)
VALUES
